...
<div id="forminator-integrations" class="wpmudev-settings--box">
    <div class="sui-box">
        <div class="sui-box-header">
            <h2 class="sui-box-title"><?php esc_html_e( "Authorizing FortressDB", FortressDB::DOMAIN ); ?></h2>
        </div>
        <div class="sui-box-body">
			<?php if ( ! empty( $vars['error_message'] ) ) : ?>
                <span
                        class="sui-notice sui-notice-error"><p><?php echo esc_html( $vars['error_message'] ); ?></p></span>
			<?php elseif ( $vars['is_close'] ): ?>
                <span class="sui-notice sui-notice-success">
					<p>
						<?php
						esc_html_e( 'Successfully authorized FortressDB, you can go back to integration settings.',
							FortressDB::DOMAIN
						);
						?>
					</p>
			...
			<?php else : ?>
                <span class="sui-notice sui-notice-loading">
					<p><?php esc_html_e( 'Please Wait...', FortressDB::DOMAIN ); ?></p>
				</span>
			<?php endif; ?>
        </div>
    </div>
